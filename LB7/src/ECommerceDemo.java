...
public class ECommerceDemo {
    public static void main(String[] args) {
        ...
        Product product1 = new Product(1, "Product 1", 100.0, 10);
        Product product2 = new Product(2, "Product 2", 50.0, 5);
        ...
        platform.updateProductStock(product1.getId(), 8);
        platform.updateProductStock(product2.getId(), 2);
